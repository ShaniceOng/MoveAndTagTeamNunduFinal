...
//enter level/scenario/map number here then press play to run the visualisation for the app
    int level=23;
    ...
    ArrayList<String[]> ObListSplit = new ArrayList<String[]>();
    ArrayList<float[]> ObListInts = new ArrayList<float[]>();
    ...
    ArrayList<float[]> LinesSplitFloats = new ArrayList<float []>();
    ArrayList<Route> routes= new ArrayList<Route>();
    ArrayList<Route> screenRoutes= new ArrayList<Route>();
    int lasttime=millis();
    int x=800;
    int y=450;
    int s=20;
    ...
    public void setup(){
        ...
        String sampleString = input.get(level-1);
        ...
        if (arrayCheck(input.get(level-1))==1){
